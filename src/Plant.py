...
class Plant:
    def __init__(self, x, y, width, height):
        ...
        self.sheet = pygame.image.load("assets/sprites/plant.png").convert_alpha()
        self.sheet = pygame.transform.smoothscale(self.sheet, (width * 6, height))  # Điều chỉnh tỉ lệ sprite sheet
        self.frames = []
        self.frame_width = self.sheet.get_width() // 5  # Giả sử có 6 khung hình trong sprite sheet
