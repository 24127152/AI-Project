...
class Slider:
    def __init__(self, x, y, width, height, min_value=0, max_value=100, initial_value=50, on_apply=None):
        ...
        # Thêm 'onclick=' cho rõ ràng
        self.apply_btn = Button(x + width + 13, y - 7, 40, 40, img_normal, img_hover, img_pressed, onclick=self.apply_value)
        ...
        # TỐI ƯU: Load font 1 lần duy nhất từ ổ cứng và lưu trữ lại
        self.font = pygame.font.Font("assets/fonts/Cyber.otf", 15)
        self.tile_text = self.font.render(f"Grid Size: {self.value} X {self.value}", True, (235, 245, 255))
    ...
    # Hàm cập nhật giá trị dựa trên vị trí chuột trên thanh trượt
    def update_value(self, mouse_x):
        ...
        new_value = self._snap_to_odd(raw_value)
        
        # TỐI ƯU: Chỉ khi giá trị grid thay đổi (vd từ 9 sang 11) thì mới tốn công tạo text mới
